...
Another easy but fun problem.

For part 1 all you have to do is to follow the instructions, how to move in those directions in a hex grid maybe a little tricky if it's your first time otherwise it should be simple.

For part 2, is a variation of conway's game of life, again it should be simple, since it was implemented in another problem this year.