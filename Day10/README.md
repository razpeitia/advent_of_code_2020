...
Part 1 was super easy, just sort and count the differences.
Part 2 took a little more time, you essentially calculate all possible ways, but you add a cache to avoid recomputing previous answers.