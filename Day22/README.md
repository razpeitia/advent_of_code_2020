...
Another simulation problem, part 1 was simple, just follow the rules.
Part 2 has more rules and have fewer tests, one thing that wasn't clear was the cache, to avoid cycles, seems that there is 1 cache per game, instead of using one global cache.
