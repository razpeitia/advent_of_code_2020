...
Well part 1 was very easy, I implemented that using a single vector and storing everything.
So, that didn't work for part 2. So, I had to re-implement it using a hash map, and an enum that can hold 1 or 2 values.
That did run but took several seconds, there should a better way!